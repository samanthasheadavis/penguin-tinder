...
const profiles = [
  require('./assets/penguin1.png'),
  require('./assets/penguin2.png'),
  require('./assets/penguin3.png'),
  require('./assets/penguin4.png'),
  require('./assets/penguin5.png')
]
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <Animated.Image source={this.state.person}
